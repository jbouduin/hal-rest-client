import { createClient, HalResource, IJSONParser, JSONParser } from ".."
...
describe('Generic JSON Parser', () => {
  ...
  test('create HalResource using JSON without _links', () => {
    ...
    const resource = parser.jsonToResource(json, HalResource);
  ...
  test('create HalModel using JSON without _links', () => {
    ...
    const resource = parser.jsonToResource(json, ToHalResourceModel);
...
describe('JSON Parser: links', () => {
  ...
  test('HalResource linking to HalResource - string links', () => {
    ...
    const resource = parser.jsonToResource(toParse, HalResource);
  ...
  test('HalModel linking to HalResource - string links', () => {
    ...
    const model = parser.jsonToResource(toParse, ToHalResourceModel);
    testToHalResourceModel(model);
  });
  ...
  test('HalModel linking to HalModel - all links are strings', () => {
    ...
    const model = parser.jsonToResource(toParse, ToModelModel);
